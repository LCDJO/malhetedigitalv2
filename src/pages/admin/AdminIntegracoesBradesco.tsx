...
export default function AdminIntegracoesBradesco() {
  return (
    <div className="space-y-8 max-w-4xl">
      <div>
        <div className="flex items-center gap-3">
          <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-red-600/10">
            <Building2 className="h-5 w-5 text-red-600" />
          </div>
          <div>
            <h1 className="text-2xl font-serif font-bold text-foreground">Bradesco</h1>
            <p className="text-sm text-muted-foreground mt-0.5">Configure as integrações com o Bradesco para boletos e PIX</p>
          </div>
        </div>
      </div>
      ...
      <section>
        <div className="flex items-center gap-2.5 mb-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-muted-foreground">Emissão e gestão de boletos via API Bradesco</p>
          </div>
          ...
          <CardContent className="p-5 sm:p-6 space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
              <div className="space-y-1.5">
                <Label className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Número da Agência</Label>
                <Input placeholder="Agência Bradesco" disabled className="h-10" />
              </div>
              <div className="space-y-1.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
              <div className="space-y-1.5">
                ...
                <Input placeholder="Ex: 09" disabled className="h-10" />
              </div>
              <div className="space-y-1.5">
                <Label className="text-xs font-medium text-muted-foreground uppercase tracking-wider">CNPJ do Beneficiário</Label>
                <Input placeholder="00.000.000/0000-00" disabled className="h-10" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
              <div className="space-y-1.5">
                ...
                <Input placeholder="client_id da API Bradesco" disabled className="h-10" type="password" />
              </div>
              <div className="space-y-1.5">
                <Label className="text-xs font-medium text-muted-foreground uppercase tracking-wider flex items-center gap-1.5">
                  <Settings2 className="h-3 w-3" /> Client Secret (API)
                </Label>
                <Input placeholder="client_secret da API Bradesco" disabled className="h-10" type="password" />
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50 border border-border/60">
              ...
              <p className="text-xs text-muted-foreground">
                ...
                <a href="https://developers.bradesco.com.br" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2">
                  Bradesco Developers
                </a>
              </p>
            </div>
        ...
        <Card className="border-border/60 shadow-sm">
          <CardContent className="p-5 sm:p-6 space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-[11px] text-muted-foreground">Certificado necessário para autenticação mTLS com a API PIX do Bradesco</p>
            </div>

            <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50 border border-border/60">
              <ExternalLink className="h-4 w-4 text-muted-foreground flex-shrink-0" />
              <p className="text-xs text-muted-foreground">
                Documentação da API PIX Bradesco disponível em{" "}
                <a href="https://developers.bradesco.com.br" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2">
