...
export default function AdminIntegracoesItau() {
  return (
    <div className="space-y-8 max-w-4xl">
      <div>
        <div className="flex items-center gap-3">
          <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-orange-600/10">
            <Building2 className="h-5 w-5 text-orange-600" />
          </div>
          <div>
            <h1 className="text-2xl font-serif font-bold text-foreground">Itaú</h1>
            <p className="text-sm text-muted-foreground mt-0.5">Configure as integrações com o Itaú para boletos e PIX</p>
          </div>
        </div>
      </div>
      ...
      <section>
        <div className="flex items-center gap-2.5 mb-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-muted-foreground">Emissão e gestão de boletos via API Itaú</p>
          </div>
          ...
          <CardContent className="p-5 sm:p-6 space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
              <div className="space-y-1.5">
                <Label className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Agência</Label>
                <Input placeholder="Nº da agência" disabled className="h-10" />
              </div>
              <div className="space-y-1.5">
                <Label className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Conta Corrente</Label>
                <Input placeholder="Nº da conta com dígito" disabled className="h-10" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
              <div className="space-y-1.5">
                ...
                <Input placeholder="Ex: 109" disabled className="h-10" />
              </div>
              <div className="space-y-1.5">
                <Label className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Código do Beneficiário</Label>
                <Input placeholder="Código fornecido pelo Itaú" disabled className="h-10" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
              <div className="space-y-1.5">
                ...
                <Input placeholder="client_id da API Itaú" disabled className="h-10" type="password" />
              </div>
              <div className="space-y-1.5">
                <Label className="text-xs font-medium text-muted-foreground uppercase tracking-wider flex items-center gap-1.5">
                  <Settings2 className="h-3 w-3" /> Client Secret (API)
                </Label>
                <Input placeholder="client_secret da API Itaú" disabled className="h-10" type="password" />
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50 border border-border/60">
              ...
              <p className="text-xs text-muted-foreground">
                ...
                <a href="https://developer.itau.com.br" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2">
                  Itaú Developer
                </a>
              </p>
            </div>
        ...
        <Card className="border-border/60 shadow-sm">
          <CardContent className="p-5 sm:p-6 space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-[11px] text-muted-foreground">Certificado necessário para autenticação mTLS com a API PIX do Itaú</p>
            </div>

            <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50 border border-border/60">
              <ExternalLink className="h-4 w-4 text-muted-foreground flex-shrink-0" />
              <p className="text-xs text-muted-foreground">
                Documentação da API PIX Itaú disponível em{" "}
                <a href="https://developer.itau.com.br" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2">
                  developer.itau.com.br
                </a>
              </p>
            </div>
