                ...
                <ProtectedRoute>
                  <DashboardLayout>
                    <Routes>
                      ...
                      <Route path="/mural" element={<ProtectedRoute navKey="mural"><Mural /></ProtectedRoute>} />
                      <Route path="/circulares" element={<ProtectedRoute navKey="circulares"><Circulares /></ProtectedRoute>} />
                      <Route path="/calendario" element={<ProtectedRoute navKey="calendario"><Calendario /></ProtectedRoute>} />
