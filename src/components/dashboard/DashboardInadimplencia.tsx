...
export function DashboardInadimplencia() {
  ...
  const taxaAdimplencia = (TOTAL_IRMAOS - inadimplentes.length) / TOTAL_IRMAOS * 100;
  ...
  return (
    <section className="space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        {/* Barra de progresso de adimplência */}
        <Card className="animate-fade-in [animation-delay:500ms]">
          ...
          <CardContent className="space-y-4">
            <div className="text-center">
              ...
              <p className="text-xs text-muted-foreground mt-1">{TOTAL_IRMAOS - inadimplentes.length} de {TOTAL_IRMAOS} em dia</p>
            </div>
